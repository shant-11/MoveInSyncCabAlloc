...
import { bwmessage, errormessage, formgroup, head1, head2, input, label, link, link2 } from '../common/formStyle'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container1} >
                <View style={styles.s1}>
                    ...
                    <Text style={styles.h1} /*onPress={() => navigation.navigate('HomeScreen')}*/>MoveInSync</Text>
